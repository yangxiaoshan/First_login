...
<form action="addStaff.action" method="post">
    <table width="88%" border="0" class="emp_table" style="width:80%;">
        ...
        <tr>
            ...
            <td width="62%">
                <select id="postID" name="model.post.postID">
                    <s:iterator value="postList" var="pl">
                        <s:if test="#pl.postID==model.post.postID">
                            <option value="${pl.postID}" selected="selected">${pl.postName}</option>
                        </s:if>
                       <s:else>
        ...
        <tr>
            <td>
                <input type="hidden" name="model.staffID" value="${model.staffID}">
            </td>
        </tr>
    </table>
</form>
